...
const arHighlights = [
  { label: "خبرة مع عدة وكالات", icon: Users },
  { label: "متخصص في التجارة الإلكترونية داخل إفريقيا", icon: ShoppingBag },
  { label: "فيديوهات منتجات ومونتاج إعلاني", icon: Clapperboard },
  { label: "محتوى إعلاني موجه للتحويل", icon: Megaphone },
  { label: "فهم ميداني للسوق الإفريقي", icon: Globe2 },
];

const arDescription =
  "يساهم سعد بلقاضي مع INNOVMARK بخبرة قوية في العمل مع الوكالات، وإنتاج فيديوهات المنتجات، والمونتاج الإعلاني، وإدارة محتوى الحملات. يفهم تحديات التجارة الإلكترونية في إفريقيا عن قرب، ويساعد العلامات على صناعة محتوى عملي وجذاب يرفع فرص البيع.";
...
export function SaadBelkaadiSection({ locale }: { locale?: Locale }) {
  ...
  return (
    <section className="relative overflow-hidden px-6 py-12 md:py-20 lg:px-10">
      <div
        aria-hidden
      ...
      <div className="relative mx-auto max-w-7xl">
        <SectionLabel
          kicker={isArabic ? "عضو رئيسي" : "Membre clé"}
          title={isArabic ? "خبرة إبداعية مصممة لدعم البيع." : "Une expertise créative pensée pour vendre."}
          subtitle={isArabic ? "تعتمد INNOVMARK على خبرات ميدانية تربط المحتوى بالأداء وبواقع الأسواق." : "INNOVMARK s'appuie aussi sur des profils terrain capables de relier contenu, performance et réalité des marchés."}
        />

        <article className="premium-glass reveal-on-scroll relative mt-10 overflow-hidden rounded-3xl p-5 shadow-[0_34px_140px_rgba(6,182,212,0.10)] md:mt-14 md:p-8 lg:p-10">
          <div
            aria-hidden
          ...
          <div className="relative grid gap-8 lg:grid-cols-[0.88fr_1.12fr] lg:items-center">
            <div className="rounded-2xl border border-white/10 bg-black/50 p-5 md:p-7">
              <div className="flex items-start gap-5">
                ...
                <div>
                  <p className="flex items-center gap-2 text-[10px] uppercase tracking-[0.32em] text-cyan-100/70">
                  ...
                  <p className="mt-3 text-sm font-medium uppercase tracking-[0.22em] text-emerald-100/72">
                    {isArabic ? "متخصص التجارة الإلكترونية والإعلانات الإبداعية" : "E-commerce & Creative Ads Specialist"}
                  </p>
                </div>
              </div>
              ...
              <Link
                ...
                className="mt-8 inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-cyan-100/20 bg-white px-6 py-3 text-sm font-semibold uppercase tracking-[0.18em] text-black transition hover:bg-emerald-100"
              >
                {isArabic ? "اعمل معنا" : "Travailler avec nous"} <ArrowRight className="h-4 w-4 rtl-arrow" />
              </Link>
            </div>
...
export function SaadBelkaadiTeaser({ locale }: { locale?: Locale }) {
  ...
  return (
    <section className="relative overflow-hidden px-6 py-8 md:py-12 lg:px-10">
      <div className="mx-auto max-w-7xl">
        <Link
          href={localizedHref("/pourquoi-nous", locale)}
          className="premium-glass reveal-on-scroll group relative flex flex-col gap-6 overflow-hidden rounded-3xl p-6 transition duration-500 hover:-translate-y-1 hover:border-cyan-200/30 md:flex-row md:items-center md:justify-between md:p-8"
        >
          <div
            aria-hidden
          ...
          <div className="relative flex gap-5">
            ...
            <div>
              <p className="text-[10px] uppercase tracking-[0.32em] text-cyan-100/64">
                {isArabic ? "عضو رئيسي" : "Membre clé"}
              </p>
              <h2 className="mt-3 text-2xl font-light tracking-tight text-white md:text-3xl">
                Saad Belkaadi
              </h2>
              <p className="mt-2 text-sm font-medium uppercase tracking-[0.18em] text-emerald-100/68">
                {isArabic ? "متخصص التجارة الإلكترونية والإعلانات الإبداعية" : "E-commerce & Creative Ads Specialist"}
              </p>
              <p className="mt-4 max-w-2xl text-sm leading-6 text-white/64">
                {isArabic ? "خبرة في فيديوهات المنتجات والمونتاج الإعلاني ومحتوى الإعلانات الموجه للتحويل لعلامات التجارة الإلكترونية في إفريقيا." : "Une expertise en vidéos produits, montage publicitaire et contenus ads orientés conversion pour les marques e-commerce en Afrique."}
              </p>
            </div>
          </div>

          <div className="relative flex items-center gap-3 text-[10px] uppercase tracking-[0.24em] text-white/64 transition group-hover:text-white">
            {isArabic ? "تعرّف على الفريق" : "Découvrir l'équipe"}

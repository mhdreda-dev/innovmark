...
const AR_MSG = encodeURIComponent("مرحباً Innovmark، أود مناقشة مشروع جديد.");
...
export default function WhatsAppFloat({ locale }: { locale?: string }) {
  ...
  return (
    <a
      ...
      aria-label={isArabic ? "تواصل عبر واتساب" : "Discuter sur WhatsApp"}
      className="group fixed bottom-4 right-4 z-50 md:bottom-6 md:right-6"
    >

...
export default function WhatsAppFloat({ locale }: { locale?: string }) {
  ...
  return (
    ...
    >
      <span className="absolute inset-0 rounded-full bg-[#4F8CFF]/[0.08] blur-md transition-opacity group-hover:opacity-100 md:blur-xl" />
      <span className="relative flex h-12 w-12 items-center justify-center rounded-full border border-[#4F8CFF]/15 bg-white text-[#4F8CFF] opacity-100 shadow-[0_8px_24px_rgba(79,140,255,0.08)] transition duration-300 group-hover:scale-105 md:h-14 md:w-14">
        <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 opacity-100 md:h-[22px] md:w-[22px]">

  ...
  return (
    <div className={`reveal-on-scroll flex min-w-0 flex-col gap-3 md:gap-4 ${alignment}`}>
      <div className="flex max-w-full items-center gap-3">
        ...
        <span className="cinematic-text text-[10px] uppercase tracking-[0.22em] text-white/72 md:text-[11px] md:tracking-[0.46em]">
          {kicker}
        </span>
      </div>
      <h2 className="cinematic-text max-w-[780px] text-2xl font-light leading-[1.12] tracking-tight text-white md:text-5xl md:leading-[1.08]">
        {title}
      </h2>
      {subtitle && (

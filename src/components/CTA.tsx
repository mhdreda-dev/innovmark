      ...
      <div className="premium-glass relative min-w-0 rounded-2xl px-4 py-9 text-center shadow-[0_24px_70px_rgba(15,23,42,0.09)] sm:px-5 md:px-10 md:py-16">
        ...
        <div className="flex flex-col items-center justify-center gap-3 sm:flex-row md:gap-4 rtl-md-row">
          <a
            ...
            className="group inline-flex min-h-11 w-full items-center justify-center gap-3 rounded-full bg-[#25D366] px-5 py-3 text-center text-sm font-medium uppercase tracking-[0.08em] text-black shadow-[0_6px_22px_rgba(37,211,102,0.2)] transition-colors hover:bg-[#1ebe5a] sm:w-auto md:px-8 md:py-4 md:tracking-[0.15em] md:shadow-[0_8px_30px_rgba(37,211,102,0.3)]"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="h-[42px] w-[42px] rounded-full border border-[#4F8CFF]/15 bg-[#4F8CFF]/[0.08] p-2.5 text-[#4F8CFF] opacity-100 shadow-[0_8px_24px_rgba(79,140,255,0.08)] transition duration-300 group-hover:scale-105">
        ...
        <div className="mt-8 hidden flex-wrap items-center justify-center gap-x-8 gap-y-3 text-xs uppercase tracking-widest text-slate-500 md:flex">
          ...
          <span className="flex items-center gap-2">
            <span className="w-1 h-1 rounded-full bg-emerald-400" />
            {isArabic ? "المغرب + الخارج" : "Morocco + International"}
          </span>
        </div>
      </div>
      </div>

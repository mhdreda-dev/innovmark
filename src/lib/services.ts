...
export const arServices: ServiceDetail[] = [
  {
    slug: "promotional-videos",
    eyebrow: "فيديوهات إعلانية",
    title: "فيديوهات كتشد الانتباه وكتبيّن قيمة المشروع ديالك بسرعة.",
    summary:
      "فيديوهات للانطلاق، ريلز وإعلانات بخدمة احترافية وهدف تجاري واضح.",
    intro:
      "كنخدمو على الفكرة، الصورة والمونتاج باش المشروع ديالك يبان قوي من أول ثلاث ثواني. كل فيديو كيتوجد على حساب فين غادي يتحط: إنستغرام، الموقع، الإعلانات، أو حملة انطلاق.",
  ...
  },
  {
    ...
    title: "مواقع سريعة وأنيقة كتخلي المشروع ديالك موثوق.",
    summary:
      "مواقع وصفحات هبوط احترافية مصممة باش تكون واضحة، سريعة، وتجيب تواصلات.",
    intro:
      "الموقع خاصو يبان مزيان، يتحل بسرعة، ويوجه الزائر بلا تعقيد. كنخدمو على الكلام، الترتيب، والتجربة باش المشروع ديالك يبان جدي فكل شاشة.",
  ...
  {
    slug: "branding",
    eyebrow: "لوغو وشكل المشروع",
    title: "نصاوبو ليك لوغو وشكل احترافي للمشروع ديالك.",
    summary:
      "لوغو، ألوان وطريقة عرض كتخلي المشروع ديالك واضح ومتناسق.",
    intro:
  ...
  },
  {
    ...
    title: "تصاميم وتتبع للإعلانات باش الطلب يكون قابل للقياس.",
    summary:

...
export const dictionaries = {
  ...
  ar: {
    ...
    home: {
      heroTitle: "INNOVMARK — خلي المشروع ديالك يبان مزيان فالإنترنت",
      heroSubtitle: "خدمة الإشهار والتواصل للمشاريع المغربية",
      heroDescription:
        "كنصاوبو مواقع، لوغو، تصاور وفيديوهات ومنشورات وإعلانات باش المشروع ديالك يبان واضح ويجيب زبناء أكثر.",
      heroCta: "طلب عرض سعر",
      heroSecondaryCta: "تواصل معنا",
      heroWhatsappMessage: "السلام عليكم INNOVMARK، بغيت عرض سعر للمشروع ديالي.",
      features: [
        { title: "شكل احترافي", description: "لوغو وألوان وطريقة عرض كتخلي المشروع ديالك واضح." },
        { title: "تصاور وفيديوهات مزيانين", description: "منشورات وإعلانات بجودة كتليق بالخدمة ديالك." },
        { title: "نتائج واضحة", description: "خطة واضحة باش تعرف شنو خدام وشنو خاص يتحسن." },
      ],
    },
    pages: {
      services: {
        kicker: "خدمات باش تبان أكثر فالإنترنت",
        title: "الخدمات ديالنا",
        subtitle:
          "خدمات كتعاون المشروع ديالك يبان مزيان، يربح الثقة، ويحول المهتمين لزبناء.",
      },
      why: {
        kicker: "ثقة وتجربة فالسوق",
        title: "علاش تختار INNOVMARK",
        subtitle:
          "كنخدمو مع مشاريع باغية تبان أكثر احترافية، تشرح القيمة ديالها بوضوح، وتكبر بخطوات منظمة.",
      },
      process: {
        kicker: "طريقة خدمة واضحة",
        title: "كيفاش كنخدمو",
        subtitle:
          "من الفكرة حتى الانطلاق، كنمشيو معاك فمراحل واضحة باش تعرف شنو غادي يدوز ووقتاش.",
      },
      contact: {
        kicker: "بريف سريع",
        ...
        processSteps: [
          {
            step: "01",
            title: "كنفهمو الحاجة",
            desc: "كنقراو الطلب ديالك باش نفهمو الأهداف، الجمهور، والنتائج اللي باغي توصل ليها.",
          },
          {
            step: "02",
            title: "اقتراح واضح",
            desc: "كنعطيوك خطة خدمة مفهومة وعرض سعر واضح فـ 24 ساعة.",
          },
          {
            step: "03",
            title: "بداية المشروع",
        ...
        serviceCards: [
          { label: "لوغو وشكل المشروع", tag: "ألوان وتصميم" },
          { label: "الموقع", tag: "موقع واضح وسريع" },
          { label: "الإشهار والتواصل", tag: "زبناء وخطة واضحة" },
        ],
        trustItems: [
          { value: "< 24h", label: "جواب سريع" },
          { value: "Pro", label: "خدمة احترافية" },
          { value: "360°", label: "مواكبة كاملة" },
        ],
      },
    },
    contactForm: {
      projectTypes: ["موقع", "لوغو وشكل المشروع", "إشهار وتواصل", "شي حاجة أخرى"],
      introStep: "سؤال بسؤال باش نوجدو بريف واضح وسريع.",
      introSimple: "المعلومات الأساسية كاملة ففورم واحد مختصر.",
      simpleMode: "رجع للفورم البسيط",
      ...
      phoneLabel: "الهاتف",
      stepLabel: "الخطوة",
      projectTypeQuestion: "شنو نوع المشروع؟",

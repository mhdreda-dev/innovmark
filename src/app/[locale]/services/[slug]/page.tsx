  ...
  return (
    <>
      ...
      <main className="relative z-10 overflow-hidden pt-24">
        <section className="relative px-6 pb-12 pt-12 md:pb-20 md:pt-20 lg:px-10">
          <div
            aria-hidden
          ...
          <div className="relative mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
            <div>
              <div className="mb-5 flex items-center gap-3">
                <span className="h-px w-9 bg-gradient-to-r from-cyan-200 via-blue-300 to-violet-400" />
                <span className="cinematic-text text-[10px] uppercase tracking-[0.42em] text-white/70">
                  {service.eyebrow}
                </span>
              </div>
              <h1 className="cinematic-text max-w-4xl text-4xl font-light leading-[1.02] tracking-tight text-white md:text-6xl lg:text-7xl">
                {service.title}
              </h1>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a
                  ...
                  className="inline-flex min-h-12 items-center justify-center rounded-full bg-white px-6 py-3 text-xs font-semibold uppercase tracking-[0.18em] text-black transition-colors hover:bg-cyan-50"
                >
                  {isArabic ? "تواصل معنا" : "Contact Us"}
                </a>
                <a
                  href={localizedHref("/services", locale)}
                  className="inline-flex min-h-12 items-center justify-center rounded-full border border-white/18 bg-white/[0.045] px-6 py-3 text-xs font-medium uppercase tracking-[0.18em] text-white/82 transition-colors hover:border-cyan-100/45 hover:text-white"
                >
            ...
            <aside className="premium-glass rounded-2xl p-5 md:p-7">
              <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-1">
                <div>
                  <span className="text-[10px] uppercase tracking-[0.26em] text-cyan-100/64">
          ...
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:gap-14">
            <div>
              <h2 className="text-2xl font-light tracking-tight text-white md:text-4xl">
                {isArabic ? "ما الذي نبنيه" : "What we build"}
              </h2>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              <div className="premium-glass rounded-2xl p-5 md:p-6">
                <h3 className="text-sm font-medium uppercase tracking-[0.22em] text-white/82">
        ...
        <section className="px-6 pb-16 pt-4 md:pb-24 lg:px-10">
          <div className="mx-auto max-w-7xl rounded-2xl border border-white/12 bg-white/[0.055] p-6 md:flex md:items-center md:justify-between md:p-8">
            <div>
              <p className="text-[10px] uppercase tracking-[0.3em] text-white/48">
                {isArabic ? "جاهزون عندما تكون جاهزاً" : "Ready when you are"}
              </p>
              <h2 className="mt-3 text-2xl font-light tracking-tight text-white md:text-4xl">
                {isArabic ? "أخبرنا بما تريد إطلاقه." : "Tell us what you want to launch."}
              </h2>
            </div>
            <a
              href={localizedHref("/contact", locale)}
              className="mt-6 inline-flex min-h-12 w-full items-center justify-center rounded-full bg-[#25D366] px-6 py-3 text-xs font-semibold uppercase tracking-[0.18em] text-black transition-colors hover:bg-[#1ebe5a] md:mt-0 md:w-auto"
            >
              {isArabic ? "افتح نموذج التواصل" : "Open contact form"}
            </a>
          </div>
        </section>
      </main>
